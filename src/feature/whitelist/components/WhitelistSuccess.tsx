    ...
    return (
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
                Congratulations! You are now eligible to receive the certificate for <strong>{event.title}</strong>.
            </p>
            ...
            <div className="space-y-3">
                <Link to={`/events/${event.id}`} className="w-full block bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-lg font-semibold transition-all">
                    Back to Event
                </Link>
                <Link to="/events" className="w-full block border border-gray-300 hover:border-blue-600 text-gray-700 hover:text-blue-600 py-3 px-4 rounded-lg font-semibold transition-all">
                    Browse More Events
                </Link>
            </div>
        </div>
