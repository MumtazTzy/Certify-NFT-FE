...
const EventStatsCard: React.FC<EventStatsCardProps> = ({ whitelisted, maxAttendees }) => {
    ...
    <div className="bg-white rounded-2xl shadow-lg p-6">
      ...
      <div className="pt-4 mt-4 border-t border-gray-200">
        <div className="text-sm text-gray-600 space-y-1">
          <p><span className="font-semibold">{whitelisted}</span> registered</p>
          <p><span className="font-semibold">{maxAttendees - whitelisted}</span> spots remaining</p>
        </div>
      </div>
    </div>
  );
